            ...
            <div class="row js-list-filter" id="js-contacts">
                ...
                $users = [
                    [
                        ...
                        "tel" => "+13174562564",
                        "email" => "mailto:oliver.kopyov@smartadminwebapp.com",
                        "address" => "15 Charist St, Detroit, MI, 48212, USA",
                        "tags" => "oliver kopyov", // data-filter-tags
                        "facebook" => "facebook.com", //адресс сами придумали для соц.сетей
                        "twitter" => "twitter.com",
