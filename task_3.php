        ...
        <main id="js-page-content" role="main" class="page-content">
            <div class="col-md-6">
                <div id="panel-1" class="panel">
                    ...
                    <!-- берём елемент, рассматриваем его, строим его структуру, потом строим массив (или переносим данные в таблицу) -->
                    <?php
                        $elements = [
                                [
                                    "title" => "My Tasks",
                        ...
                        <div class="panel-content">
                            ...
                            <?php foreach ($elements as $element): ?>
                                <div class="d-flex mt-2">
                                    <?= $element['title'] ?>
                                    <span class="d-inline-block ml-auto"><?= $element['value'] ?></span>
                                </div>
                                <div class="progress progress-sm mb-3">
                                    <div class="progress-bar <?= $element['background']; ?>" role="progressbar" style="width: <?= $element['width']; ?>;" aria-valuenow="<?= $element['valuenow']; ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            <?php endforeach; ?>
