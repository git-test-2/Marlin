                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <?php
                                $images = [
                                        [
                                                "path" => "img/demo/gallery/21.jpg", // большая картинка
                                                "thumb" => "img/demo/gallery/thumb/21.jpg" //урезанная картинка
                                        ],
                                    [
                                        "path" => "img/demo/gallery/22.jpg",
                                        "thumb" => "img/demo/gallery/thumb/22.jpg"
                                    ],
                                    [
                                        "path" => "img/demo/gallery/23.jpg",
                                        "thumb" => "img/demo/gallery/thumb/23.jpg"
                                    ],
                                    [
                                        "path" => "img/demo/gallery/24.jpg",
                                        "thumb" => "img/demo/gallery/thumb/24.jpg"
                                    ],
                                    [
                                        "path" => "img/demo/gallery/25.jpg",
                                        "thumb" => "img/demo/gallery/thumb/25.jpg"
                                    ],
                                    [
                                        "path" => "img/demo/gallery/26.jpg",
