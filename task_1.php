<?php
//меняем формат html на php
//делаем олинаковые "h2" и убираем класс у "p"
//делаем 2 массива
//выводим в цикле
$posts = [
        [
        ...
        [
            "title" => "Ещё один пост",
            "description" => "совершенно другой пост =)"
        ],
];
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
                                <?php foreach ($posts as $post): ?> <!-- для вывода текста, НО если цикл php должен что-то делать (ф-ю) то лучше foreach() {} -->
                                    <h2><?php echo $post['title']; ?></h2>
                                    <p><?php echo $post['description']; ?></p>
                                <?php endforeach;?>
<!--                            <h2>Privacy</h2>-->
<!--                            <p>  удалили класс class="mb-g" -->
...
<!--                                We will retain your personal information only for as long as is necessary for the purposes for which the information was collected, or as long as is required pursuant to law.-->
<!--                            </p>-->
<!--                            <h2>Cookies and other similar technologies</h2>  поставили h2 вместо h3 -->
<!--                            <p>-->
