...
//                                             ?>
                                        <?php foreach ($result as $res): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="<?= $res['photo']; ?>" width="75">
                                                </td>
                                                <td><?= $res['login']; ?></td>
                                                <td><?= $res['role']; ?></td>
                                                <td><?= $res['gender']; ?></td>
                                                <td>
                                                    <a href="show.php?id=<?= $res['id']; ?>" class="btn btn-info">Посмотреть</a>
                                                    <a href="edit.php?id=<?= $res['id']; ?>" class="btn btn-warning">Изменить</a>
                                                    <a href="delete.php?id=<?= $res['id']; ?>" class="btn btn-danger">Удалить</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
<!--                                        <tr>-->
